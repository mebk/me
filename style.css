...
Description: دانلود کتاب
Author: میهن ایبوک
Author URI: http://mihanebook.com
Version: 3.13
********************************/
@font-face{font-family: "IRANSans";
            font-weight: 300;
            src: url("http://www.mihanebook.com/wp-content/themes/Eroid/inc/Fonts/IRANSans-Light-Expanded.eot?#") format("eot"),
            url("http://www.mihanebook.com/wp-content/themes/inc/Fonts/IRANSans-Light-Expanded.woff2") format("woff2"),
            url('http://www.mihanebook.com/wp-content/themes/inc/Fonts/IRANSans-web.ttf') format('truetype'),
            url("http://www.mihanebook.com/wp-content/themes/inc/Fonts/IRANSans-Light-Expanded.woff") format("woff");font-style:normal;font-weight:normal;}
/*This set of fonts are used in this project under the license: (DBDWL)*/
...
body{background:#F4F4F4;direction:rtl;color:#555;margin:0px;padding:0px;text-align:center;font:11px/1.9 tahoma;overflow-x:hidden;}
a{text-decoration:none;color:#555;transition:all 0.3s ease-out;}
a:hover{text-decoration:none;color:#97C024;}
ul, li{border:0;padding:0;margin:0;list-style:none;}
img{border:0;transition:all 0.3s ease-out;}
.post .body img:hover{border:3px solid #4f869c; border-radius:4px;}
...
h1{font:1.7em/1.6 'IRANSans',tahoma}
h2,h3,h4,h5,h6{font:1.2em/1.2 'IRANSans',tahoma;}
.nav,.warpper{width:95%;margin:0px auto;}
.warpper{text-align:right;display:inline-block;}
.hidden{opacity:0;}
.visible{opacity:1;}
.page_body{width:73%;float:right;margin-top:10px;text-align:center;}
.menu, .menu2{background:#4774b7;height:70px;margin-bottom:3px;overflow:hidden;}
.logo{float:right;width:30%;}
.logo .img{float:right;background:url('http://www.mihanebook.com/wp-content/themes/Eroid/images/179512.svg') no-repeat 0px 0px;width:54px;height:53px;margin:9px 0px 9px 9px;border-radius:10%;}
.logo h1{font:30px/42px IRANSans,tahoma;color:#97C024;text-align:right;position:relative;overflow:hidden;height:42px;white-space:nowrap;text-overflow:ellipsis;}
.logo h2{font:13px IRANSans,tahoma;color:#969696;text-align:right;overflow:hidden;text-overflow:ellipsis;height:23px;white-space:nowrap;}
...
.menu li a{font:15px/72px IRANSans,tahoma;color:#FAFAFF;margin:0px 5px;padding:24px 5px 22px;position:relative;transition:none 0s ease 0s;}
...
.menu2{background:#589bff;height:36px;overflow:hidden;}
.menu2 li a{font:13px/34px IRANSans,tahoma;color:#fff;padding:7px 5px 8px;margin-left:5px;}
...
.notbox .title{font:13px IRANSans,tahoma;text-align:right;padding:7px 10px;border-bottom:1px dashed #e5e5e5;color:#98C024;}
...
.search {
	background: url('http://www.mihanebook.com/wp-content/themes/Eroid/images/mhb.jpeg') no-repeat fixed 0px 0px/cover #f2f2f2;
	height: 313px;
}
.search h3{font:15px IRANSans,tahoma;margin:20px 0px;display:inline-block;color:#A358E0;text-shadow:0px 0px 1px rgba(147, 188, 34, 0.3); padding-top:5%;}
.search form {
	width: 80%;
	margin: 0px auto;
	height: 88px;
	border: 3px solid rgba(135, 24, 24, 0);
	overflow: hidden;
	border-radius: 75px;
}
.search input{background:rgba(255, 255, 255, 0.75);width:88%;height:89px;text-indent:2em;float:right;color:#333;}
.search button{background:#4380CF;color:#FFF;font:17px/4 IRANSans,tahoma;padding:7px 0px 12px;float:left;width:12%;cursor:pointer;}
.search button:hover{background:#C04125;}
...
.special .icon{background:url('images/sprites.png') no-repeat 0px -223px #E5E5E5;color:#999;height:40px;width:40px;border-radius:30%;font:13px/36px IRANSans,tahoma;float:right;}
...
.special .text span{display:block;font:15px IRANSans,tahoma;color:#666;}
...
.special .taabs span{display:block;text-align:right;font:13px IRANSans,tahoma;padding:4px 0px;cursor:pointer;margin:0px 0px 4px;background:#ebebeb;border-radius:3px;color:#777;}
.special .taabs span:last-child{border:0px}
.special .taabs .active{background:#97C024;color:#fff;}
...
.sidebar{float:left;width:26%;margin-top:10px;}
...
.sidebar .title h4{font:16px/36px IRANSans,tahoma;float:right;}
...
.category > ul > li > span{position:absolute;left:0px;top:7px;font:14px IRANSans,tahoma;color:#E47211;}
.category > ul > li > ul > li > span{display:none;}
.category > ul > li > a{display:block;border-bottom:2px solid #e5e5e5;padding:5px 5px 10px;font:13px IRANSans,tahoma;color:#777;}
.category > ul > li > a:hover{padding-right:10px;color:#444;}
.category > ul > li > ul > li > a{color:#777;}
.category > ul > li > ul > li:hover > a,.post .body a:hover,.sidebar .body li a:hover{color:#98c024}
...
.tabs span{padding:3px 8px;margin:0px 2px;border:1px solid #D9D9D9;border-radius:3px;font:13px IRANSans,tahoma;display:inline-block;cursor:pointer;}
...
.widgetpost .title h3{text-align:right;font:14px/35px IRANSans,tahoma;}
.widgetpost .content{padding:7px;color:lavender;}
...
.sidebar .archive{background:#05436B;}
.sidebar .newsletter{background:#555;}
.sidebar .newsletter h4,.sidebar .archive h4{color:#fff}
.archive ul{margin:5px 0px 7px;width:100%;font:14px/29px IRANSans,tahoma;float:right;max-height:150px;}
...
.newsletter strong{float:right;color:#fff;margin:14px 0px 0px 0px;font:12px IRANSans,tahoma;}
...
.request{background:#FC8602;width:100%;display:inline-block;margin-bottom:10px;text-align:right;font:25px IRANSans,tahoma;padding:10px 0px;border-radius:8px;position:relative;}
.request span:last-child{font:18px IRANSans,tahoa;display:block;color:#123bed;}
...
.textads a{display:block;font:15px IRANSans,tahoma;background:#F2F2F2;margin-bottom:5px;padding:5px;border-radius:3px;color:#777;height:24px;overflow:hidden;}
...
.buy img{width:72%;height:auto;}
.buy h3{font:15px IRANSans,tahoma;text-align:center;border-bottom:1px dashed #e5e5e5;padding:4px 0px 8px;color:#82a41e;}
.buy .text{margin:10px;}
.buy .body{overflow-y:auto;height:288px;background:#FFF;text-align:initial;width:95% !important;padding:0px 8px;}
...
.buy .foot a{float:left;margin:12px 10px;background:#de3358;color:#FFF;padding:5px 10px;border-radius:3px;box-shadow:2px 2px 0px #ebebeb;font:15px IRANSans,tahoma;}
...
.buy .foot span{float:right;margin:12px 10px;font:13px/32px IRANSans,tahoma;}
...
.posts .status{position:absolute;left:5px;background:#DE3358;padding:0px 6px;font:13px IRANSans,tahoma;color:#fff;border-radius:3px;top:5px;opacity:0.8;}
...
.posts .title{font:14px IRANSans,tahoma;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;margin:53px 10px 5px;color:#333;}
...
.posts .more a{background:#98C024;padding:1px 10px;border-radius:3px;font:15px IRANSans,tahoma;color:#FFF;float:left;margin:34px 10px 5px;}
...
.cmp{float:right;font:13px IRANSans,tahoma;position:relative;margin:7px 12px 6px;}
.cmp a{color:#666}
...
.post .title h2 {
	...
	height: 24px;
	margin-left: 6em;
	border-bottom: 2px dashed #e4d3d3;
	background-color: #d1edd633;
}
.post .title a {
	color:#297eb4;
}
...
.post .content {
	background: #E7E9E780;
	border-radius: 5px;
	box-shadow: 0px 0px 8px #B6C9DAB3;
}
.post .body{padding:7px 10px 0px;text-align:initial;font: normal 14px/2.1em 'IRANSans';}
...
.post .body h1{font:17px IRANSans,tahoma;}
.post .body h2{font:15px IRANSans,tahoma;}
.post .body h3{font:13px IRANSans,tahoma;}
...
.post .info{border-bottom:1px dashed #E5E5E5;height:40px;padding:6px 10px;margin-bottom:5px;margin-right:9em;overflow:hidden;}
...
.post .date span{display:block;color:#777;text-align:center;font:19px/12px IRANSans,tahoma;margin-top:5px;}
.post .date span:nth-child(2){font:12px/0 IRANSans,tahoma;margin-top:10px;}
...
.post .more a{background:#279eea;color:#fff;padding:5px 50px;font:15px IRANSans;margin:10px 12px;display:inline-block;border-radius:5px;box-shadow: 2px 2px 2px #67baef99;position:relative;}
.post .more a:nth-of-type(2n){background:#fff;}
.post .more a:hover{background:#44C09D;}
...
.download .bodi {
	background: url('http://www.mihanebook.com/wp-content/themes/Eroid/images/201571.svg') no-repeat center bottom #3580B7;
	border-radius: 60px 4px 40px 4px;
	position: relative;
	float: right;
	width: 100%;
	min-height: 220px;
...
.download .links{width:30%;font:13px IRANSans,tahoma;float:right;margin:20px 15px 10px;}
...
.download .links a{margin-bottom:6px;padding:5px 10px;border-radius:3px;display:inline-block;color:#fff;background:#555;text-decoration:none;}
.download .links a:before{margin:3px 0px 0px 9px;}
.download .links a:hover{background:#97c024;color:#fff}
...
.help span{float:right;color:#ffa500;margin:0px 5px;font:13px/24px IRANSans,tahoma;}
...
.postex a.poplight{font:13px IRANSans,tahoma !important;color:#666 !important;}
...
.codeahang{float:left;background:#FDAD02;color:#FFF;font:13px IRANSans,tahoma;padding:2px 5px;cursor:pointer;}
...
.popup .ti{font:14px IRANSans,tahoma;border-bottom:1px dashed #F2F2F2;padding:5px 10px 10px;color:#98c024;text-align:right;}
...
.post .tag .tite{float:right;font:13px IRANSans,tahoma;color:#808080;margin-left:3px;}
...
.post_link .previous span,.post_link .next span{font:13px IRANSans,tahoma;color:#666;display:block;}
...
.breadcrumbs .icon{font:15px/21px IRANSans,tahoma;float:right;color:#666;text-indent:3px;}
.socials .icon{float:right;font:15px/40px IRANSans,tahoma;color:#666;}
...
.related,.comments{background:#b48e23cc;border-radius:3px;margin-bottom:10px;}
.related{height:240px;overflow:hidden;border-radius: 313px;}
.related .title,.comments .title{height:45px;border-bottom:1px dashed #E5E5E5;font:15px/44px IRANSans,tahoma;text-align:right;padding:0px 10px;color:#000;padding-right: 110px;}
.comments .title span{background:#E5E5E5;padding:3px 5px;font:13px IRANSans,tahoma;float:left;margin:10px 0px 0px;border-radius:3px;}
...
.related li{display:inline-block;width:11%;height:160px;overflow:hidden;border-bottom:3px dotted #0098B1;margin:10px 5px 0px;line-height:18px;}
...
.related img {
	...
	max-width: 100%;
	height: auto;
border: 2px dotted #f6ec1a;
}
.related img:hover {border:2px dashed green;
}
.commentlist{padding:10px;background-color: #D9E8C080;}
...
.commentlist li{color:#888;font:13px IRANSans,tahoma;}
...
.form-submit #submit{font-family:IRANSans,tahoma;border:0px;}
...
.bypostauthor .fn:after{content:"مدیر";font:11px tahoma;background:#98c024;border-radius:3px;color:#FFF;margin:5px 5px 5px 0px;padding:0px 5px 3px;}
...
.comment-reply-title a:before{content:"x";margin:0px 0px 0px 5px;font:13px/1px IRANSans,tahoma;}
...
.pagenavi .pages:before{content:"صفحات";float:right;font:15px/17px IRANSans,tahoma;padding-top:3px;width:100%;}
...
float: right;
width: 100%;
background: url('http://www.mihanebook.com/wp-content/themes/Eroid/images/footer.jpg');
height: 300px;}
.tags{height:37px;overflow:hidden;}
.tags h5{float:right;font:16px/27px IRANSans,tahoma;padding:5px 10px;}
...
.star_ratings .txt{position:absolute;right:0px;z-index:9;font:15px/68px IRANSans,tahoma;color:#00902a;}
...
.star_ratings .ps-star-ratings{background:#1b2638;border-radius:3px;border:0px;margin-bottom:5px;}
...
.archive li{width:46%;}
.request{font:20px/45px IRANSans,tahoma}
.request span:last-child{font:13px/25px IRANSans,tahoa;}
...
.posts .title{font-size:13px IRANSans,tahoma;margin:35px 10px 5px;}
...
.navicon2 b{float:right;font:15px IRANSans,tahoma;color:#98C024;overflow:hidden;width:110px;text-align:right;height:23px;}
...
.menu li a{font:13px/45px IRANSans,tahoma;color:#777;margin:0px;padding:0px;position:relative;display:block;transition:all 0.3s ease-out 0s;border-bottom:1px dashed #3b3b3b;}
...
.post .title h2{font:13px/23px IRANSans,tahoma;}
...
/*new*/
.postbox{float:right;margin:10px 0 0;width:70%;}
.latestforum{background:#9DC573 repeat scroll 0 0 white;margin:0 0 10px;}
.latestforum h3 {
	background: url("images/icons.gif") no-repeat scroll right -104px rgba(0, 0, 0, 0);
	border-bottom: 1px solid #bfb6b6b3;
	float: right;
	padding: 28px 35px 23px 0;
	width: 95%;
	color: #150c6e;
}
.leftside{float:left;margin:10px 0 0;width:28.75%;}
.lastposts{background:none repeat scroll 0 0 #fff;margin:0 0 10px;}
.lastposts h3{border-bottom:1px solid #eee;border-right:3px solid #eee;padding:2px 6px;}
.lastposts h3 span{background:url("images/sprite.png") no-repeat scroll right -37px rgba(0, 0, 0, 0);padding:2px 30px 0 0;}
.lastposts ul{padding:5px 0;}
.lastposts ul li a{padding:0 9px;}
.lastposts ul li a:hover{}
.leftside, .postbox{float:none;width:100%;}
#menu ul li:hover{background-color:#f9f9f9 !important;}
.latestforum li{color:#ff6500;list-style:square outside none;padding:0 4px 0 0;white-space:nowrap;}
.latestforum > ul {
	/* clear: both; */
	margin: 0 0 0 13px;
	overflow: hidden;
...
.goto{float:left;}
.btn{background-color:#ff9900;color:#ffffff !important;padding:3px 6px;}
.btn:hover{background-color:#ff6500;}
.footer p {
	color: #0b0947;
	background: rgba(95, 86, 86, 0.4);
}
.post.mihanebook {
	margin-bottom: 10px;
	width: 96%;
